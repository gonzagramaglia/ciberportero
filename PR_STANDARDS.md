...
| #9 | `style/ui-enhancements` | Enhance footer spacing, English banners, and plan scrollbar | ✅ Merged |
| #10 | `feat/global-music-football-buttons` | Add global floating music and football buttons across pages | ✅ Merged |
| #11 | `style/mobile-countdowns-and-admin-auth` | Layout for mobile countdowns and admin auth buttons | 📝 Open |
