        ...
        <div style={{ background: '#f8fafc', minHeight: '100vh', width: '100%' }}>
            ...
            <div style={{ 
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center', width: '100%', maxWidth: '450px' }}>
                    ...
                    >
                        <svg width="20" height="20" viewBox="0 0 24 24" style={{ filter: 'grayscale(1)', opacity: 0.7, flexShrink: 0 }}>
                        ...
                        <span style={{ fontSize: '0.65rem', background: '#f1f5f9', padding: '0.2rem 0.4rem', borderRadius: '6px', fontWeight: '800', color: '#94a3b8', flexShrink: 0 }}>{roomsT.soon}</span>
                    </button>
