...
import { Plus, Trash2, CheckCircle, Clock, ExternalLink, Book, MessageSquare, Check, Zap } from "lucide-react"
                              ...
                              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.3rem' }}>
                                ...
                                <div style={{ display: 'flex', gap: '1rem', marginTop: '0.1rem', flexWrap: 'wrap' }}>
                                  ...
                                  <span style={{ fontSize: '0.8rem', color: 'var(--muted)', display: 'flex', alignItems: 'center', gap: '0.4rem', fontWeight: '600' }}>
                                    <Clock size={14} /> {new Date(item.fecha + 'T12:00:00').toLocaleDateString(lang === 'es' ? 'es-AR' : 'en-US')}
                                  </span>
                                </div>
                              </div>
                            </div>
