export const translations = {
    es: {
        ...
        contact: {
            title: "Consultas Oficiales UNDEF",
        ...
        links: [
            ...
            { name: 'Clases de la Lic. en Ciberdefensa (Youtube)', url: 'https://www.youtube.com/@licenciaturaenciberdefensa', desc: 'Canal oficial con clases grabadas y material de estudio en video' },
        ...
        calendar: {
            ...
            allSubjectsOfPeriod: "Todas las materias del cuatri",
            allPeriods: "Todos los cuatrimestres",
            allTypes: "Todos los tipos de eventos",
            firstPeriod: "1er cuatrimestre de 1er año",
            secondPeriod: "2do cuatrimestre de 1er año",
        ...
        rooms: {
            ...
            lobbyTitle: "Salas de Estudio",
            description: "Este es tu espacio colaborativo para estudiar en grupo.",
            access: "Acceso",
            signInPrompt: "Iniciá sesión para unirte a grupos de estudio\no crear el tuyo.",
    ...
    en: {
        ...
        contact: {
            title: "Official UNDEF Inquiries",
            description: "Official contact channel for academic and administrative inquiries",
            email: "licciberdefensa@fadena.undef.edu.ar",
            copied: "Copied!"
        },
        links: [
            ...
            { name: 'Classes of the Bachelor\'s in Cyberdefense (YouTube)', url: 'https://www.youtube.com/@licenciaturaenciberdefensa', desc: 'Official channel with recorded classes and study material' },
        ...
        calendar: {
            ...
            allSubjectsOfPeriod: "All subjects of the semester",
            allPeriods: "All semesters",
            allTypes: "All event types",
            firstPeriod: "1st semester of 1st year",
            secondPeriod: "2nd semester of 1st year",
        ...
        rooms: {
            title: "Room Entry",
            lobbyTitle: "Study Rooms",
            description: "Your collaborative space to study in groups.",
            access: "Room Entry",
            signInPrompt: "Sign in to join study groups\nor create your own.",
    ...
    pt: {
        ...
        rooms: {
            ...
            lobbyTitle: "Salas de Estudo",
            description: "Seu espaço colaborativo para estudar em grupo.",
            access: "Ingresso às Salas",
            signInPrompt: "Faça login para participar de grupos de estudo\nou criar o seu.",
