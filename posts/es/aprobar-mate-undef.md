---
title: "Cómo aprobar el Curso de Matemática"
date: "2026-03-04"
...
# Cómo aprobar el Curso de Matemática

> 📚 El [**Curso de Matemática**](https://campus.fadena.undef.edu.ar/course/view.php?id=539) es parte del **Ingreso a FADENA**. Aprobarlo con un **80% o más** es un **requisito indispensable para poder inscribirse a las materias anuales** de la Licenciatura en Ciberdefensa.
...
- **Autoevaluaciones:** Son **obligatorias**. Deben completarse al final de cada unidad temática para poder avanzar y, lo más importante, son un **requisito para habilitar el examen final** del curso.
